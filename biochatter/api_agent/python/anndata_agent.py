...
FOR THE MapAnnData, BE SURE TO ALWAYS USE THE variable of the anndata GIVEN IN THE INPUT, REPLACE IT IN THE api_name
...
class ConcatenateAnnData(BaseAPIModel):
    ...
    api_name: str = Field(default="anndata.concat", description="NEVER CHANGE")
...
class ReadH5AD(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_h5ad", description="NEVER CHANGE")
...
class ReadZarr(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_zarr", description="NEVER CHANGE")
    filename: str = Field(
...
class ReadCSV(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_csv", description="NEVER CHANGE")
    filename: str = Field(
...
class ReadExcel(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_excel", description="NEVER CHANGE")
    filename: str = Field(
...
class ReadHDF(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_hdf", description="NEVER CHANGE")
...
class ReadLoom(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_loom", description="NEVER CHANGE")
    filename: str = Field(
...
class ReadMTX(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_mtx", description="NEVER CHANGE")
    filename: str = Field(
...
class ReadText(BaseAPIModel):
    ...
    api_name: str = Field(default="io.read_text", description="NEVER CHANGE")
    filename: str = Field(
